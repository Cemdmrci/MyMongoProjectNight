...
namespace MyMongoProjectNight.Controllers
{
	public class MailController : Controller
	{
		...
		public IActionResult SendMail(string name, string email)
		{
			...
			MailboxAddress mailboxAddressFrom = new MailboxAddress("FoodMart", "demircicem1907@gmail.com");
			...
			using (SmtpClient client = new SmtpClient())
			{
				...
				client.Authenticate("demircicem1907@gmail.com", "pwrn emut zpux yekk");
